...
CONTAINS
  ...
  SUBROUTINE transform_to_momentum_space(psi, rank, dims, psik )
    ...
    CALL FourierTransform(psik,rank,dims)
  ...
  SUBROUTINE FourierTransform_MPI(in, rank, dims_local, dims_global)
...
!!$      END IF
    ...
    END SUBROUTINE FourierTransform_MPI
